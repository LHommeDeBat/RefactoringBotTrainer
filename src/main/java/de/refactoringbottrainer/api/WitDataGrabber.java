package de.refactoringbottrainer.api;
...
import de.refactoringbottrainer.configuration.WitConfiguration;
...
public class WitDataGrabber {
	...
	public WitObject getWitObjectFromMessage(String message) throws RestClientException {
		...
		headers.set("Authorization", "Bearer " + witConfig.getWitClientToken());
